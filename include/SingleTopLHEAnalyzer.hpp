...
// Tue Sep 10 12:17:36 2019 by ROOT version 5.34/32
// from TTree LHEF/Analysis tree
// found on file: unweighted_events_ctW_0.root
//////////////////////////////////////////////////////////

#ifndef SingleTopLHEAnalyzer_h
#define SingleTopLHEAnalyzer_h
...
public :
   ...
   SingleTopLHEAnalyzer(TTree *tree=0);
   virtual ~SingleTopLHEAnalyzer();
...
#ifdef SingleTopLHEAnalyzer_cxx
SingleTopLHEAnalyzer::SingleTopLHEAnalyzer(TTree *tree) : fChain(0)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
	//InputFile = "unweighted_events_ctW_0.root";
   if (tree == 0) {
...
SingleTopLHEAnalyzer::~SingleTopLHEAnalyzer()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t SingleTopLHEAnalyzer::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t SingleTopLHEAnalyzer::LoadTree(Long64_t entry)
{
...
void SingleTopLHEAnalyzer::Init(TTree *tree)
{
...
Bool_t SingleTopLHEAnalyzer::Notify()
{
...
void SingleTopLHEAnalyzer::Show(Long64_t entry)
{
...
Int_t SingleTopLHEAnalyzer::Cut(Long64_t entry)
{
...
#endif // #ifdef SingleTopLHEAnalyzer_cxx
